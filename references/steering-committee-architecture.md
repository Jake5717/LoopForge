...
```python
DOMAIN_EXPERTS = {
    "container-monitor.py": "Senior SRE / container infrastructure Specialist",
    "resource-check.py": "Infrastructure / Capacity Planning Engineer",
    ...
    "daily-briefing": "SRE / Incident Response Lead",
    "governance-audit": "Governance / Compliance Auditor",
    "knowledge-digest": "Knowledge Management Specialist",
    "Product Research": "Market Research / Competitive Analyst",
    "thread-organizer": "Community Manager",
    "news-digest": "AI/ML Research Analyst",
